...
export const title = "Genghis, Graphs and Middle Management";
export const short_title = "Genghis, Graphs and Middle Management";
export const description = "Why middle management appears, and how to build a future without";
export const author = "Abel Riboulot, Andrej Zukov Gregoric";
export const published_date = "Oct 23, 2020";
export const last_revised_date = "Oct 23, 2020";
export const repo = "NA"
export const id = "genghis"
